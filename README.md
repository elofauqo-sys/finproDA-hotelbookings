...
jumlah tamu dewasa dan anak-anak,

harga rata-rata per malam (Average Daily Rate),

jenis pelanggan,

serta status pemesanan (dibatalkan atau tidak).

Dengan melakukan segmentasi pelanggan, pihak manajemen hotel dapat:

Mengidentifikasi pola perilaku tamu, seperti kelompok pelanggan yang sering memesan jauh hari atau yang lebih sensitif terhadap harga.

Menentukan strategi pemasaran yang lebih efektif, misalnya memberikan promosi tertentu kepada segmen pelanggan yang sering membatalkan pesanan.

Meningkatkan efisiensi operasional, dengan memprediksi permintaan kamar dari masing-masing segmen.

Meningkatkan loyalitas pelanggan, dengan menawarkan layanan yang sesuai dengan kebutuhan dan preferensi tiap segmen.
